  ...
  return (
    <div>
      ...
      <div className="steps">
        ...
        <div className="userSteps">
          <div className="buyer">
            ...
            <p className="content">
              -Then start exploring the products listed by your friends on
              eduPad
            </p>
          ...
          <div className="seller">
            ...
            <h4 className="header">Step 3:</h4>
            <p className="content">
              -Wait for approval from your college admin
            </p>

            <h4 className="header">Step 4:</h4>
            <p className="content">
              -Start adding products you want to sell and send an approval
              request to your college admin
            </p>
            <p className="note">
      ...
      <div className="getstartedContainer">
        <a className="getstarted" href="./loginPage.html">
          Get Started
        </a>
      </div>
    </div>
