...
for mark in range(5):                   #using for loop five times to check whether the subject mark is 90 or above, or 40 or above
    if(subjects[mark] >= 90):           #using if to check whether the mark is greater than or equal to 90
        ...
        count_for_50 += 1               #increasing count for 50 by 1
        count_for_40 += 1               #increasing count for 40 by 1
    elif(subjects[mark] >= 50):         #using elif to check whether the mark is greater than or equal to 50
        count_for_50 += 1               #increasing count for 50 by 1
        count_for_40 += 1               #increasing count for 40 by 1
    elif(subjects[mark] >= 40):         #using if to check whether the mark is greater than or equal to 40
        count_for_40 += 1               #increasing count for 40 by 1

if(count_for_60 == 5):                              #using if to check whether the student has scored above 60 in all subjects
    print("Student passed the degree")              #printing that the student has passed the degree
elif(count_for_90>=3 and count_for_40>=2):        #using elif to check if the student has scored 90 or above in 3 or more subjects and 40 or above in 2 or more subjects
    print("Student passed the degree")          #printing that the student has passed the degree
elif(count_for_75>=3 and count_for_50>=2):      #using elif to check if the student has scored 75 or above in 3 or more subjects and 50 or above in 2 or more subjects
    print("Student passed the degree")          #printing that the student has passed the degree
