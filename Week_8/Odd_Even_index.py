...
if(len(word) % 2 == 0):             #checking whether the length of the word is even to fix the starting index
    startValue = len(word) - 2      #initializing start value
else:
    startValue = len(word) - 1      #initializing start value

for letter in range(startValue, -1, -2):       #iterating through the word by even index
    print(word[letter], end = "")               #printing the letter
